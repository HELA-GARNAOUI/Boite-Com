    ...
    <footer className="border-t bg-background">
      <div className="container grid gap-8 py-8 md:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-4">
          <h3 className="text-lg font-medium">Agency</h3>
          <p className="text-sm text-muted-foreground">Providing digital solutions for businesses since 2010.</p>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link href="/services/social-media" className="hover:underline">
                Social Media Management
              </Link>
            </li>
            <li>
              <Link href="/services/erp-integration" className="hover:underline">
                ERP Integration
              </Link>
            </li>
            <li>
