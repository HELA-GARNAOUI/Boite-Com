...
OPENAI_API_KEY = os.getenv('OPENAI_API_KEY', '')  # La clé API sera chargée depuis les variables d'environnement
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@digitalagency.com')
